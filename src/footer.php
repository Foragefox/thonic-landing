<!-- Footer-->
<footer class="footer bg-black text-white-50">
    ...
    <div class="row">
      <div class="col-12 col-md-6 text-center text-md-start">
        ...
        <div class="social-links">
          ...
          <a href="https://t.me/thonicf" target="_blank" rel="noopener"><i class="fab fa-telegram"></i></a>
        </div>
      </div>
      <div class="col-12 col-md-6 text-center text-md-end pt-3">
        <span class="small">Copyright &copy; Thonic <?= date('Y') ?></span>
      </div>
    </div>
  </div>
</footer>