    ...
    <div class="container">
            ...
            <div class="col">
                <div class="d-flex">
                    <div class="flex-shrink-0">
                        <img class="profile-img" src="/img/profile-demetri.png" alt="...">
                    </div>
                    <div class="flex-grow-1 ms-3">
                        <h3>Demetri M.</h3>
                        <p>Demetri is an experienced entrepreneur who has launched several successful businesses and currently sits as a Partner and Managing Director for a digital agency. He is a seasoned professional who has developed and managed client projects in the US and international markets.</p>
                        <p>Demetri has worked in business development and the computer science industry for 15 years and has been involved with real estate and securities investment for fourteen years. Furthemore, he has been working with block chain change technology for 2 years and holds a Bachelor of Science in Computer Science.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col">
                <div class="d-flex">
                    <div class="flex-shrink-0">
                        <img class="profile-img" src="/img/profile-deyan.png" alt="...">
                    </div>
                    <div class="flex-grow-1 ms-3">
                        <h3>Deyan I.</h3>
                        <p>Deyan is an electrical engineer turned self-taught software, mobile, and web developer. His journey from electrical engineering to software engineering and app development showcases his remarkable ability to adapt and innovate across disciplines. He is a critical thinker with a technological skill set that helps bring to life the ideas and solutions of Thonic.</p>
                        <p>As part of the company leadership Deyan helps shape Thonic's strategic direction and inspires a culture of continuous learning and innovation among the team. From engineering to entrepreneurship Deyan exemplifies a commitment to excellence and a passion for creating meaningful technological advancements.</p>
                    </div>
                </div>
            </div>
        </div>
